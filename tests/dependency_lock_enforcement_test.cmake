...
function(lock_component component_id output_variable)
    ...
    foreach(component_index RANGE 0 ${last_component})
        ...
        if(candidate_id STREQUAL component_id)
            string(JSON component GET "${lock_json}" components ${component_index})
            set(${output_variable} "${component}" PARENT_SCOPE)
            return()
        endif()
    endforeach()
...
string(JSON component_count LENGTH "${lock_json}" components)
lock_component(tdlib duplicate_component)
