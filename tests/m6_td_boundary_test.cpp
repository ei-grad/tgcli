...
TEST_CASE("M6 TD function names form the exact accepted boundary", "[m6][td-runtime]") {
    constexpr std::array expected{
        ...
        std::pair{TdFunctionKind::CreateChatInviteLink,
                  std::string_view{"createChatInviteLink"}},
        std::pair{TdFunctionKind::RevokeChatInviteLink,
                  std::string_view{"revokeChatInviteLink"}},
        std::pair{TdFunctionKind::SetChatMemberStatus,
                  std::string_view{"setChatMemberStatus"}},
        std::pair{TdFunctionKind::SetChatPermissions,
                  std::string_view{"setChatPermissions"}},
        std::pair{TdFunctionKind::GetStorageStatistics,
                  std::string_view{"getStorageStatistics"}},
