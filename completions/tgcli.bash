...
_tgcli_complete() {
  ...
  if (( COMP_CWORD == 1 )); then
    ...
    case "$top" in
      ...
      completion) candidates='--json --verbose -v --no-daemon --no-color' ;;
    ...
    case "$key" in
      ...
      chat\ set-permissions) candidates='--account --json --allow-write --dry-run --timeout --idempotency-key --verbose -v --no-daemon --no-color --allow --deny' ;;
      ...
      chats) candidates='--account --json --timeout --cursor --verbose -v --no-daemon --no-color --folder --archived --unread -n' ;;
      completion) candidates='--json --verbose -v --no-daemon --no-color' ;;
      contact\ add) candidates='--account --json --allow-write --dry-run --timeout --idempotency-key --verbose -v --no-daemon --no-color --first-name --last-name --phone' ;;
      ...
      contact\ search) candidates='--account --json --timeout --verbose -v --no-daemon --no-color -n' ;;
      ...
      folder\ create) candidates='--account --json --allow-write --dry-run --timeout --idempotency-key --verbose -v --no-daemon --no-color --chat --icon --color-id' ;;
      folder\ delete) candidates='--account --json --allow-write --dry-run --yes --timeout --idempotency-key --verbose -v --no-daemon --no-color' ;;
      folder\ edit) candidates='--account --json --allow-write --dry-run --timeout --idempotency-key --verbose -v --no-daemon --no-color --name --icon --color-id --clear-icon' ;;
      ...
      storage\ optimize) candidates='--account --json --allow-write --dry-run --yes --timeout --verbose -v --no-daemon --no-color --chat-limit' ;;
      storage\ stats) candidates='--account --json --timeout --verbose -v --no-daemon --no-color --chat-limit' ;;
      topic\ close) candidates='--account --json --allow-write --dry-run --timeout --idempotency-key --verbose -v --no-daemon --no-color' ;;
      topic\ create) candidates='--account --json --allow-write --dry-run --timeout --idempotency-key --verbose -v --no-daemon --no-color --icon-color --icon-custom-emoji-id' ;;
